...
//    @Override
//    public void onBindViewHolder( SimilarRecipeViewHolder holder, int position) {
...
//        textView_similar_title=itemView.findViewById(R.id.textView_title);
//        textView_similar_serving=itemView.findViewById(R.id.textView_servings);
